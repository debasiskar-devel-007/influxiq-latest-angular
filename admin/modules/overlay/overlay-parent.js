...
Drupal.overlay.create = function () {
  ...
  // the page in a hidden (inactive) iframe the admin doesn't see the white
 ...
 * admin tabs to it. This function can be used to set the document focus to
...
Drupal.overlay.eventhandlerOverrideLink = function (event) {
  ...
  if (href != undefined && href != '' && target.protocol.match(/^https?\:/)) {
    ...
    // Open admin links in the overlay.
      ...
      // Only override default behavior when left-clicking and admin is not
    ...
    // Non-user links should close the overlay and open in the main window,
