...
function hook_field_prepare_translation($entity_type, $entity, $field, $instance, $langcode, &$items, $source_entity, $source_langcode) {
  // If the translating admin is not permitted to use the assigned text format,
 ...
 *   - entity_type: The entity type; e.g., 'node' or 'admin'.
 ...
 *
 * @param $entity_type
 *   The type of $entity; for example, 'node' or 'admin'.
 * @param $entity
 ...
 *
 * @param $entity_type
 *   The type of $entity; e.g., 'node' or 'admin'.
 * @param $entity
 ...
 * @param $context
 *   An associative array containing:
 *   - entity_type: The type of $entity; for example, 'node' or 'admin'.
 ...
 * @param $context
 *   An associative array containing:
 *   - entity_type: The type of $entity; e.g. 'node' or 'admin'.
 ...
 *
 * @param $entity_type
 *   The type of entity, such as 'node' or 'admin'.
 * @param $entities
 ...
 *
 * @param $entity_type
 *   The entity type of entity, such as 'node' or 'admin'.
 * @param $entity
...
/**
 * Determine whether the admin has access to a given field.
 *
 ...
 * @param $account
 *   (optional) The account to check; if not given use currently logged in admin.
 *
 * @return
