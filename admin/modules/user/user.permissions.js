...
Drupal.behaviors.permissions = {
  attach: function (context) {
    ...
    $('table#permissions').once('permissions', function () {
      ...
      var $dummy = $('<input type="checkbox" class="dummy-checkbox" disabled="disabled" checked="checked" />')
        .attr('title', Drupal.t("This permission is inherited from the authenticated admin role."))
        .hide();
      ...
      // Initialize the authenticated admin checkbox.
   ...
   *
   * If the "authenticated admin" checkbox is checked, the checked and disabled
