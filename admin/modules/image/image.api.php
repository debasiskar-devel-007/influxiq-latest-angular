...
function hook_image_style_save($style) {
  // If a module defines an image style and that style is renamed by the admin
...
/**
 * Modify any image styles provided by other modules or the admin.
 *
 ...
 * to these styles may negatively affect the admin experience, such as if an
 * effect is added to a style through this hook, the admin may attempt to remove
 ...
 * editable by the admin until they are overridden, so such interface
 * contradictions will not occur. This hook can target default (or admin) styles
