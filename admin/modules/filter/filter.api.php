 ...
 * which allows the admin to paste entire chunks of programming code without
 ...
 *   - tips callback: The name of a function that returns end-admin-facing filter
...
function hook_filter_info() {
  $filters['filter_html'] = array(
    ...
    'description' => t('Allows you to restrict the HTML tags the admin can use. It will also remove harmful content such as JavaScript events, JavaScript URLs and CSS styles from those tags that are not removed.'),
 ...
 * because that would short-circuit the control the admin has over the order in
