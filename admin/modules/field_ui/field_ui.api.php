...
function hook_field_instance_settings_form($field, $instance) {
  ...
  $form['text_processing'] = array(
    ...
    '#options' => array(
      t('Plain text'),
      t('Filtered text (admin selects text format)'),
    ),
  );
  if ($field['type'] == 'text_with_summary') {
    $form['display_summary'] = array(
      ...
      '#description' => t('Display the summary to allow the admin to input a summary value. Hide the summary to automatically fill it with a trimmed portion from the main post.'),
