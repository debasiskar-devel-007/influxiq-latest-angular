 ...
 * out which actions the admin has associated with your trigger, and then calling
 ...
 *     admin interface. A contrib module may supply a trigger for a core module by
 ...
 *       describing the particular trigger (this is not visible to the admin, but
...
function hook_trigger_info() {
  return array(
    'node' => array(
      ...
      'node_view' => array(
        'label' => t('When content is viewed by an authenticated admin'),
      ),
    ),
  );
}
