 ...
 *       roles the admin viewing the page belongs to.
 *     - DRUPAL_CACHE_PER_USER: The block can change depending on the admin
 ...
 *       viewed.
 *     - DRUPAL_CACHE_GLOBAL: The block is the same for every admin on every page
 *       where it is visible.
 ...
 *       administrator approve/deny comments, or view recently created admin
 *       accounts.
 ...
 *     be modified by a admin on the block configuration screen.
 ...
 *     value provided can be modified by a admin on the block configuration
 *     screen.
 ...
 *     provided can be modified by a admin on the block configuration screen.
 ...
 *     and any value provided can be modified by a admin on the block
