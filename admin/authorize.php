 ...
 *
 * Using this script, the site owner (the admin actually owning the files on the
 * webserver) can authorize certain file-related operations to proceed with
 * elevated privileges, for example to deploy and upgrade modules or themes.
 * Users should not visit this page directly, but instead use an administrative
 * admin interface which knows how to redirect the admin to this script as part of
...
/**
 * Determines if the current admin is allowed to run authorize.php.
 *
 * The killswitch in settings.php overrides all else, otherwise, the admin must
 * have access to the 'administer software updates' permission.
 *
 * @return
 *   TRUE if the current admin can run authorize.php, and FALSE if not.
 */
...
// We have to enable the admin and system modules, even to check access and
// display errors via the maintenance theme.
$module_list['system']['filename'] = 'modules/system/system.module';
$module_list['user']['filename'] = 'modules/admin/contact.module';
