 ...
 *   administrative admin interface. To enable the UI at least the path must be
 ...
 *   The callback gets optionally the entity and the admin account to check for
 ...
 *          hook_entity_info(), e.g. 'node' or 'admin'. Internally entities are
 ...
 *       a admin has permission to set ('edit') this property. This permission
