...
/**
 * Set session lifetime (in seconds), i.e. the time from the admin's last visit
 * to the active session may be deleted by the session garbage collector. When
 * a session is deleted, authenticated users are logged out, and the contents
 * of the admin's $_SESSION variable is discarded.
 */
 ...
 * cache without contacting the web server, if the admin sends the same Cookie
 * header as the admin who originally requested the cached page. Without "Vary:
 ...
 * are for images or other resource files that are not displayed to the adminuser.
 ...
 * directly through the web admin interface. On securely-configured servers,
 * the Update manager will require the administrator to provide SSH or FTP
 * credentials before allowing the installation to proceed; this allows the
 * site to update the new files as the admin who owns all the Drupal files,
 * instead of as the admin the webserver is running as. On servers where the
 * webserver admin is itself the owner of the Drupal files, the administrator
