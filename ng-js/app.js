...
//
    ...
    $stateProvider
        ...
        .state('ordr-contract-details', {
            url: "/ordr-contract-details/:id",
            views:{
                'admin_top_menu': {
                    templateUrl: 'partials/admin_top_menu.html',
                    controller:'admin_header'
                ...
                'admin_content':{
                    templateUrl:'partials/ordr_contract_details.html',
                    controller:'ordercontractdetails'
                },
...
influx.controller('index', function($scope,$state,$cookieStore,$http,$uibModal,$rootScope) {
    console.log($cookieStore.get('affiliatecode'));
...
*/
    ...
    $scope.pop_pen = function(item,size){
        ...
        $cookieStore.put('platformprice',item.product_price);
        $scope.platform_estimated_time=$cookieStore.put('platform_estimated_time',item.estimated_time);
...
influx.controller('design', function($scope,$state,$cookieStore,$http,$uibModal,$rootScope,$sce) {
   ...
   // $cookieStore.put('contentid',3);
    ...
    if(typeof ($cookieStore.get('platformid')) != 'undefined'){
        $scope.selectstring +='You’ve already selected a web platform ';
    ...
    if(typeof ($cookieStore.get('contentid')) != 'undefined'){
            $scope.selectstring +=', creative content';
    ...
    if(typeof ($cookieStore.get('markettingid')) != 'undefined'){
            ...
            $scope.selectstring +=', presence development';
    ...
    $http({
        ...
        async: false,
        url: $scope.adminUrl + 'productnamelist',
        data    : $.param({'id':$scope.id,'platform_id':$scope.platform_id}),
        headers: {'Content-Type': 'application/x-www-form-urlencoded'}
    ...
    $scope.selectstring +=' and web design ';
    $scope.type += ' You may Select';
    $scope.selectstring += ' package';
    ...
    $scope.pop_design = function(item,size) {
        if (typeof ($cookieStore.get('platformid')) != 'undefined') {
            ...
            if(typeof ($cookieStore.get('designid')) == 'undefined') {
                ...
                if (typeof ($cookieStore.get('designid')) != 'undefined') {
                    ...
                    $http({
                        ...
                        data    : $.param({'id':$scope.designid}),
                        headers :   { 'Content-Type': 'application/x-www-form-urlencoded' }

                    }).success(function(data){


                        $scope.designname=data.category_name;
                    ...
                    $scope.design_estimated_time = $cookieStore.put('design_estimated_time', item.estimated_time);
            ...
            console.log($scope.selectstring);
            $uibModal.open({
                animation: true,
...
influx.controller('content', function($scope,$state,$cookieStore,$http,$uibModal,$rootScope,$sce) {
   ...
   console.log($scope.selectedarray);
    ...
    $scope.selectstring += ' and creative content';
    $scope.type += ' You may Select';
    $scope.selectstring += ' package';
    ...
    $scope.pop_content = function(item,size) {
        if (typeof ($cookieStore.get('platformid')) != 'undefined') {
            if(typeof ($cookieStore.get('contentid')) == 'undefined') {
                ...
                $cookieStore.put('content_estimated_time', item.estimated_time);
                $scope.contentid = $cookieStore.get('contentid');
                if (typeof ($cookieStore.get('contentid')) != 'undefined') {
                    ...
                    $http({
                        ...
                        async:false,
                        url:$scope.adminUrl+'categorydetails',
                        data    : $.param({'id':$scope.contentid}),
                        headers :   { 'Content-Type': 'application/x-www-form-urlencoded' }

                    }).success(function(data){


                        $scope.contentname=data.category_name;
                       // $scope.selectstring +=$scope.contentname;
                    })
...
influx.controller('presencedevelopement', function($scope,$state,$cookieStore,$http,$uibModal,$rootScope,$stateParams,$sce) {
    ...
    $scope.selectstring += ' and presence development';
    $scope.type += ' You may Select';
    $scope.selectstring += ' package';
        ...
        if (typeof ($cookieStore.get('platformid')) != 'undefined') {
            ...
            if(typeof ($cookieStore.get('markettingid')) == 'undefined'){
                ...
                $http({
                    ...
                    async:false,
                    url:$scope.adminUrl+'categorydetails',
                    data    : $.param({'id':$scope.markettingid}),
                    headers :   { 'Content-Type': 'application/x-www-form-urlencoded' }

                }).success(function(data){


                    $scope.markettingname=data.category_name;
                    //$scope.selectstring +=$scope.markettingname;
                })
              ...
              //  $scope.selectstring +=' package';
                ...
                $cookieStore.put('marketting_estimated_time', item.estimated_time);
...
influx.controller('contract', function($scope,$window,$state,$cookieStore,$http,$uibModal,$rootScope,$stateParams,$sce) {
    ...
    $scope.platform_estimated_time=0;
    $scope.design_estimated_time=0;
    $scope.content_estimated_time=0;
    $scope.marketting_estimated_time=0;
    ...
    if (typeof ($cookieStore.get('platformid')) != 'undefined') {
        ...
        $http({
           ...
           // $rootScope.platformprice = data.product_price;
            //$rootScope.platform_estimated_time=data.estimated_time;
            $rootScope.platform_estimated_time=data.estimated_time;
            if(typeof(data.estimated_time)!='undefined'){
                $cookieStore.put('platform_estimated_time',data.estimated_time);
            }
    ...
    if (typeof ($cookieStore.get('designid')) != 'undefined') {
        ...
        $http({
           ...
           // $rootScope.design_estimated_time=data.estimated_time;
            if(typeof(data.estimated_time)!='undefined'){
                $cookieStore.put('design_estimated_time',data.estimated_time);
            }
 ...
 /*           if (typeof ($cookieStore.get('contentprice')) != 'undefined') {
                ...
                $rootScope.content_estimated_time=data.estimated_time;

            }
*/            if(typeof(data.estimated_time)!='undefined'){
                $cookieStore.put('content_estimated_time',data.estimated_time);
            }
    ...
    if (typeof ($cookieStore.get('markettingid')) != 'undefined') {
        ...
        $http({
            ...
            if(typeof(data.estimated_time)!='undefined'){
                $cookieStore.put('marketting_estimated_time',data.estimated_time);
            }
          /*  if (typeof ($cookieStore.get('markettingprice')) != 'undefined') {
                $scope.markettingprice=$cookieStore.get('markettingprice');
                $rootScope.marketting_estimated_time=data.estimated_time;
            }*/
    ...
    if (typeof ($cookieStore.get('platform_estimated_time')) != 'undefined') {
        $scope.platform_estimated_time=$cookieStore.get('platform_estimated_time');
    }

    if (typeof ($cookieStore.get('design_estimated_time')) != 'undefined') {
        $scope.design_estimated_time=$cookieStore.get('design_estimated_time');
    }
    if (typeof ($cookieStore.get('content_estimated_time')) != 'undefined') {
        $scope.content_estimated_time=$cookieStore.get('content_estimated_time');
    }
    if (typeof ($cookieStore.get('marketting_estimated_time')) != 'undefined') {
        $scope.marketting_estimated_time=$cookieStore.get('marketting_estimated_time');
    }
    ...
    $scope.totalestimatedtime=parseInt($scope.platform_estimated_time)+parseInt($scope.design_estimated_time)+parseInt($scope.content_estimated_time)+parseInt($scope.marketting_estimated_time);
    ...
    $scope.removeplatform=function(){
        ...
        $cookieStore.remove('platform_estimated_time');
        $cookieStore.remove('design_estimated_time');
        $cookieStore.remove('content_estimated_time');
        $cookieStore.remove('marketting_estimated_time');
        $cookieStore.remove('affiliatecode');



        //$state.go('contract');
        //window.location.reload();
        $window.location.href = $scope.baseUrl+'web-platform';
    }

    $scope.removedesign=function(){ƒ
        $cookieStore.remove('designid');
        $cookieStore.remove('designprice');
        $cookieStore.remove('design_estimated_time');
        $cookieStore.remove('affiliatecode');
    ...
    $scope.fontcontractsubmit=function() {
        ...
        if (typeof ($cookieStore.get('affiliatecode')) != 'undefined') {
            $scope.form.product_affiliate_code=$cookieStore.get('affiliatecode');
        }
        ...
        $http({
            ...
            $uibModal.open({
                animation: true,
                templateUrl: 'frontcontract.html',
                controller: 'ModalInstanceCtrl',
                size: 'lg',
                scope: $scope
            });
    ...
    $scope.mail_submit=function(){
        ...
        if($scope.fontcontractform.$valid==true) {
            ...
            $http({
                ...
                $rootScope.globalplatformid = 0;
                $scope.frontemail=$scope.form.email;
                $uibModal.open({
                    animation: true,
                    templateUrl: 'frontcontractmail.html',
                    controller: 'ModalInstanceCtrl',
                    size: 'lg',
                    scope: $scope
                });
...
influx.controller('mailcontract', function($scope,$window,$state,$cookieStore,$http,$uibModal,$rootScope,$stateParams,$sce) {
    $('html, body').animate({ scrollTop: 0 }, 1000);
    $scope.trustAsHtml=$sce.trustAsHtml;
    $scope.contentdetailsarr=[];
    $scope.form={};
    ...
    $http({
        ...
        if (data.is_active == 1) {
            $state.go('index');
            //$window.location.href = $scope.baseUrl+'index';
        }
        else{
            if (typeof(data.client_name) != 'undefined') {
                $scope.client_name = data.client_name;
                $scope.form.client_name=$scope.client_name;

            }
            if (typeof(data.client_company) != 'undefined') {
                $scope.client_company = data.client_company;
                $scope.form.client_company=$scope.client_company;
            ...
            angular.forEach(data.content, function (value, key) {
                ...
                if (typeof(value.designid) != 'undefined') {
                    ...
                    $scope.design_id = value.designid;
            ...
            $http({
                ...
                $scope.contentdetails = data;
                console.log($scope.contentdetails.length);
                /*if (typeof ($cookieStore.get('contentprice')) != 'undefined') {
                 $scope.contentprice=$cookieStore.get('contentprice');
            ...
            if (typeof ($cookieStore.get('platformid')) != 'undefined' && typeof ($cookieStore.get('platformprice')) != 'undefined') {
                $scope.contentdetailsarr.push({
                    platformid: $cookieStore.get('platformid'),
                    platformprice: $cookieStore.get('platformprice'),
                });
            }
            if (typeof ($cookieStore.get('designid')) != 'undefined' && typeof ($cookieStore.get('designprice')) != 'undefined') {
                $scope.contentdetailsarr.push({
                    designid: $cookieStore.get('designid'),
                    designprice: $cookieStore.get('designprice'),
                });
            }
            if (typeof ($cookieStore.get('contentid')) != 'undefined' && typeof ($cookieStore.get('contentprice')) != 'undefined') {
                $scope.contentdetailsarr.push({
                    contentid: $cookieStore.get('contentid'),
                    contentprice: $cookieStore.get('contentprice'),
                });
            }
            if (typeof ($cookieStore.get('markettingid')) != 'undefined' && typeof ($cookieStore.get('markettingprice')) != 'undefined') {
                $scope.contentdetailsarr.push({
                    markettingid: $cookieStore.get('markettingid'),
                    markettingprice: $cookieStore.get('markettingprice'),
                });
            }
            ...
            $scope.fontcontractsubmit=function(){
                ...
                $scope.form.contrcatcontentid=$scope.contrcatcontentid;
                console.log($scope.form);
                $http({
                    method  :   'POST',
                    async   :   false,
                    ...
                    $uibModal.open({
                        animation: true,
                        templateUrl: 'frontcontractbymail.html',
                        controller: 'ModalInstanceCtrl',
                        size: 'lg',
                        scope: $scope
                    });
...
influx.controller('footer', function($scope,$state,$cookieStore,$http,$uibModal,$rootScope,$timeout) {
    ...
    if($state.current.name == 'consulting'){
        $rootScope.currentstate='consulting';
    }
    if($state.current.name == 'web-design'){
        $rootScope.currentstate='web-design';
    }
    if($state.current.name == 'creative-content'){
        $rootScope.currentstate='creative-content';
    }
...
influx.controller('affiliatelist',function($scope,$state,$http,$cookieStore,$rootScope,$uibModal){
    ...
    $scope.search = function(item){
        ...
        if ( (item.affiliate_name.indexOf($scope.searchkey) != -1) || (item.affiliate_email.indexOf($scope.searchkey) != -1) ||(item.affiliate_date.indexOf($scope.searchkey) != -1)||(item.product_affiliate_code.indexOf($scope.searchkey) != -1)){
            return true;
        }
        return false;
    };
...
//console.log('http://influx.spectrumiq.com/products/'+item.product_affiliate_code);
    ...
    $scope.seoaffiliatecode = function(item,size){
        $scope.seocode=$scope.baseUrl+'affiliates/creative-content/'+item.seo_affiliate_code;
        //$('.url_text').val('http://influx.spectrumiq.com/products/'+item.product_affiliate_code);
//console.log('http://influx.spectrumiq.com/products/'+item.product_affiliate_code);
        $uibModal.open({
            animation: true,
...
/*
            ...
            if($scope.type=='creative-content'){
                $window.location.href = $scope.baseUrl+'creative-content';
            }
*/
...
influx.controller('leadlist',function($scope,$state,$http,$cookieStore,$rootScope,$uibModal){
    ...
    $scope.search = function(item){
        ...
        if ( (item.fullname.indexOf($scope.searchkey) != -1) || (item.email.indexOf($scope.searchkey) != -1) ||(item.subject.indexOf($scope.searchkey) != -1)||(item.message.indexOf($scope.searchkey) != -1) ||(item.contact_date.indexOf($scope.searchkey) != -1) ){
            return true;
        }
        return false;
    };
...
influx.controller('orderlist',function($scope,$state,$http,$cookieStore,$rootScope,$uibModal){
    ...
    $scope.search = function(item){
        ...
        if ( (item.client_name.indexOf($scope.searchkey) != -1) || (item.email.indexOf($scope.searchkey) != -1) ||(item.client_company.indexOf($scope.searchkey) != -1)||(item.aff_name.indexOf($scope.searchkey) != -1)||(item.orderdate.indexOf($scope.searchkey) != -1) ||(item.price.indexOf($scope.searchkey) != -1)||(item.signature.indexOf($scope.searchkey) != -1)){
            return true;
        }
        return false;
    };
...
influx.controller('ordercontractdetails',function($scope,$state,$http,$cookieStore,$rootScope,$uibModal,$stateParams,$sce){
    ...
    $http({
        method: 'POST',
        async: false,
        url: $scope.adminUrl + 'orderdetailscontract',
        data: $.param({'id': $scope.contrcatcontentid}),
        headers: {'Content-Type': 'application/x-www-form-urlencoded'}
